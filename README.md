...
Content is managed in [Sanity.io](https://madegglabscom.sanity.studio) and deployed via Static Site Generation (SSG) using [Astro](https://astro.build/) on [Netlify](https://www.netlify.com/).
